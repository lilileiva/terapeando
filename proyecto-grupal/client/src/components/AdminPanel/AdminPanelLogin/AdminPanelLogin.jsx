            ...
            <Stack width='100%' height='80%' direction='column' justifyContent='center' alignContent='center' alignItems='center'>
                ...
                <Stack width='inherit' height='inherit' ml='1em' mr='1em' direction='column' justifyContent='center' alignItems='center'>
                    ...
                    <Stack pr='1em' pl='1em' mb='0.5em'>
                        <Text color='#63caa7' fontSize='5xl' fontWeight='500' mt='0.5em' mb='0.5em'>Portal Psico</Text>
                    </Stack>

                    {/* <Stack width='30em' bg='#d6d6d6' borderRadius='1em' pr='1em' pl='1em' mb='2em' boxShadow={`0px 0px 10px 0px rgba(0,0,0,0.3)`}> */}
                    ...
                    <Stack width='30em' height='70%' mt='1em' p='3em' pl='4em' pr='4em' bg='gray.100' boxShadow={`0px 0px 10px 0px rgba(0,0,0,0.3)`} borderRadius='1em' direction='column' justifyContent='space-between'>
